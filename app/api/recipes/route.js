...
export async function POST(req) {
  ...
  try {
    ...
    const messages = [
    {
        ...
        content:[ {
            type:"text",
            text:"return the json structure based on user requirement. Only return the json structure, nothing else. in the sample format of {\"recipe_name\":\"Recipe Name\",\"items\":{\"item1\":\"quantity\",\"item2\":\"quantity\",...},\"description\":\"how to make the recipe in steps(just steps).\" ```json}",     
        },
    ],
    },
    {
